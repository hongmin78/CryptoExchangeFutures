...
namespace CEF.Common.Helper
{
    ...
    public class RegexUtil
    {
        ...
        private static class RegexUtilHelper
        {
            internal static readonly RegexUtil INSTANCE = new RegexUtil();
        }
        /// <summary>
        /// 静态实例化单体模式
        ...
        {
            return RegexUtilHelper.INSTANCE;
        } 
        #endregion
        ...
        /// <summary>
        /// 判断输入的字符串是否只包含数字和英文字母,并且只能输入4到16长度
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static bool MatchAccount(string input)
        {
            return IsMatch(@"^[A-Za-z0-9]{4,16}$", input);
        }
